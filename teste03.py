...
musicas = []
pymusic = {'ASTOLFO':0}
musicas = [{'titulo': 'ola', 'cantor': 0, 'estilo':'rock'}]
...
def consultaMusica(musicas: list) -> None:
	...
	if getMusicaByName(musicas,name) == False:
		print("Musica não cadastrada")
            ...
            #[x[name] == name for x in musicas]
            #print('Musica: {}; Cantor: {}; Estilo: {}'.format(0,0,0))
		    #idcantor =  musicas['cantor']
		    #print('Código do cantor: ', pymusic[consult])
		    #Criar um for para percorrer essa lista
